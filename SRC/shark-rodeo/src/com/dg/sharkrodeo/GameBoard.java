...
//	private Texture _mountedTouchFailureTexture;
...
//		Shark crapShark = new Shark(this);
//		crapShark.setPosition(300, 1200);
//		_sharks[0] = crapShark;
		
//		Shark crapShark2 = new Shark(this);
//		crapShark2.setPosition(800, 1200);
//		_sharks[1] = crapShark2;
		
//		Shark crapShark3 = new Shark(this);
//		crapShark3.setPosition(1200, 400);
//		_sharks[2] = crapShark3;
...
//		_oceanLayers[4] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), -192f, -8f, .572f);
//		_oceanLayers[5] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -160, -24f, .715f);
//		_oceanLayers[6] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -224, -40f, .858f);
//		_oceanLayers[7] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), -128, -64f, 1f);
/*		
		_oceanLayers[8] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), -128f, -8f, .2f);
		_oceanLayers[9] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -224, -24f, .25f);
		_oceanLayers[10] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -160, -40f, .3f);
		_oceanLayers[11] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), -192, -56f, .35f);
		
		_oceanLayers[12] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), -192f, -16f, .7f);
		_oceanLayers[13] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -160, -32f, .75f);
		_oceanLayers[14] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -224, -48f, .8f);
		_oceanLayers[15] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), -128f, -72f, .85f);
*/		
		
/*		
		_oceanLayers[16] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), 0, 0);
		_oceanLayers[17] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -96, -16f);
		_oceanLayers[18] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -32, -32f);
		_oceanLayers[19] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), -64, -48f);
		
		_oceanLayers[20] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), -64f, -8f);
		_oceanLayers[21] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -32, -24f);
		_oceanLayers[22] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -96, -40f);
		_oceanLayers[23] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), 0, -64f);
		
		_oceanLayers[24] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), -128f, 0);
		_oceanLayers[25] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -224, -16f);
		_oceanLayers[26] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -160, -32f);
		_oceanLayers[27] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), -192, -48f);
		
		_oceanLayers[28] = new OceanLayer(AnimationFactory.createAnimation(.42f, 2, 4, layerTex), -192f, -8f);
		_oceanLayers[29] = new OceanLayer(AnimationFactory.createAnimation(.38f, 2, 4, layerTex), -160, -24f);
		_oceanLayers[30] = new OceanLayer(AnimationFactory.createAnimation(.34f, 2, 4, layerTex), -224, -40f);
		_oceanLayers[31] = new OceanLayer(AnimationFactory.createAnimation(.3f, 2, 4, layerTex), -128f, -64f);
*/
	...
	public boolean update(float delta)
	{
		...
		for (Shark curShark : _sharks)
		{
			if(curShark != null)
			{
				...
				else if ((curShark.getSharkState() != SharkState.MOUNTED) && (curShark.getSharkState() != SharkState.MOUNTING) && (curShark.getSharkState() != SharkState.THRASHING))
				{//this isnt great but it shoul work, yeah?
					curShark.setAccelerationRate(SharkRodeoConstants.getSharkAcceleration());
					curShark.setMaxSpeed(SharkRodeoConstants.getSharkMaxSpeed());
				}
				...
				for(Shark curInnerShark : _sharks)
				{
					if((curInnerShark != null) && (curInnerShark != curShark))
					{
						...
						if(lenSquared < radSquared)
						{
							...
							Utils.collideCircularGameObjects(new Circle(curSharkPos.x, curSharkPos.y, sharkBounds.radius),
									new Circle(curInnerSharkPos.x, curInnerSharkPos.y, innerSharkBounds.radius),
									curShark, curInnerShark);
						}
					}
				}
			}
...
//		spawnPowerup(); //TODO: hackish
		...
		{
			_hud.deactivateButton(UtilityButtonType.SPRINT);
		}
...
//				Gdx.input.cancelVibrate();
	...
	public void spawnWave()
	{
		...
		for(int i = 0; i < _waves.length; ++i)
		{
			if(_waves[i] == null)
			{
//				Gdx.app.log(SharkRodeoConstants.LOG_TAG, "***********: spawnwave: x:" + xPos + " y:" + yPos);
	...
	public void spawnWhirlpool()
	{
		...
		Animation bottomAnim = AnimationFactory.createAnimation(.3f, 1, 2, bottomTex);
		Animation topAnim = AnimationFactory.createAnimation(.3f, 1, 2, topTex);
...
//		Gdx.app.log(SharkRodeoConstants.LOG_TAG, "***********: spawnpowerup");
	...
	public void beginPlayerDeath()
	{
		...
		else
		{
			...
			_dialogTimer = 3f;
//			_player.setPosition(100f, 100f);
//			resetCamera();
//			_dialog = new SharkRodeoDialog(_dialogAtlas.findRegion("dialog_dead"));
		}
