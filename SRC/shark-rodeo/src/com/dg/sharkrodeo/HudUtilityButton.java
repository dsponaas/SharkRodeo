...
public class HudUtilityButton {
	...
	public HudUtilityButton(Hud hud, int position, TextureRegion activeTexture, TextureRegion inactiveTexture, UtilityButtonType type)
	{
		_hud = hud;
	...
	public void activate()
	{
		...
		if((playerState == PlayerState.IDLE) || (playerState == PlayerState.MOVING))
		{
			...
			{
				_active = true;
				_hud.getGameBoard().getPlayer().setSprint(true);
			}
		}
	}
	public void deactivate()
	{
		...
		{
			_hud.getGameBoard().getPlayer().setSprint(false);
		}
	}
