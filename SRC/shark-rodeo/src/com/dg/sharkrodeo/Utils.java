...
//		float g1NewVelX = (v1Tangent * unitTangent.x) + (v2Normal * unitNormal.x);
//		float g1NewVelY = (v1Tangent * unitTangent.y) + (v2Normal * unitNormal.y);
...
//		float g2NewVelX = (v2Tangent * unitTangent.x) + (v1Normal * unitNormal.x);
//		float g2NewVelY = (v2Tangent * unitTangent.y) + (v1Normal * unitNormal.y);
